  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
      <div className="bg-white rounded-lg shadow-lg p-4 max-w-md w-full relative">
        ...
        <div className="mb-2 text-center font-bold">Sponsored</div>
        <ins
          className="adsbygoogle"
          style={{ display: "block", width: "100%", minHeight: 90 }}
          data-ad-client="ca-app-pub-3136730634801361"
          data-ad-slot="3167358817"
          data-ad-format="auto"
...
export default function MediaDownloader() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      setDownloadHistory((prev) => [newDownload, ...prev.slice(0, 9)])
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 transition-all duration-500">
        ...
        <div className="relative z-10 container mx-auto px-4 py-8">
          ...
          {/* Second Ad Banner below video preview */}
          <AdBanner />
          ...
          {/* Second banner ad below download history */}
          <AdBanner2 />
